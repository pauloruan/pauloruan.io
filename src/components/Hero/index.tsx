...
export function Hero(): JSX.Element {
  return (
    <div className="flex flex-nowrap flex-col w-full h-full min-h-[50vh] justify-center items-center">
      <div className="flex flex-col h-full min-w-[30%] w-full justify-start items-start my-1">
        <h1 className="max-w-max max-h-max font-sans text-4xl font-black text-left my-1 py-1 text-black dark:text-white">
          Olá, eu sou o PR!
        </h1>
