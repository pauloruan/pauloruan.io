...
export function Card(props: Post): JSX.Element {
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="w-full h-full flex flex-col justify-center items-start shadow-md transition-all duration-300 ease-in-out cursor-pointer rounded-md px-4 py-2 bg-cod-gray-200 dark:bg-cod-gray-800"
    >
